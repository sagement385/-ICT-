...
| 건강보험심사평가원_의료기관별상세정보서비스 | [공공데이터포털](https://www.data.go.kr/data/15001699/openapi.do) | `15001699` | 건강보험심사평가원 | 공공데이터포털 발급 서비스키 `ServiceKey` | `HIRA_API_KEY` 또는 `PUBLIC_DATA_API_KEY` | 주요 5개 endpoint HTTP 200 실제 응답 확인. 저장소 fixture는 민감정보 방지를 위해 미등록 | raw client 구현. 실제 샘플 fixture 확보 후 상세 parser 구현 예정 | 포털에 실시간 표시 | 2026-07-15 확인 | `getEqpInfo2.8`, `getSpclDiagInfo2.8`, `getSpcSbjtSdrInfo2.8`, `getDgsbjtInfo2.8`, `getDtlInfo2.8` |
